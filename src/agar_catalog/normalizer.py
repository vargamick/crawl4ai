...
from .util import ensure_directory, safe_filename
    ...
    def save_normalized_files(
        ...
        if separate_files:
            ...
            if catalog_data.products:
                ...
                products_data = [product.model_dump(mode="json") for product in catalog_data.products]
            ...
            if catalog_data.media:
                ...
                media_data = [media.model_dump(mode="json") for media in catalog_data.media]
            ...
            if catalog_data.documents:
                ...
                documents_data = [doc.model_dump(mode="json") for doc in catalog_data.documents]
            ...
            if catalog_data.categories:
                ...
                categories_data = [cat.model_dump(mode="json") for cat in catalog_data.categories]
            ...
            if catalog_data.product_categories:
                ...
                relationships_data = [rel.model_dump(mode="json") for rel in catalog_data.product_categories]
        ...
        if combined_file:
            ...
            combined_data = catalog_data.model_dump(mode="json")
            ...
            for media in media_by_product.get(product.product_id, []):
                if media.media_type == "image":
                    legacy_product["images"].append({
                        ...
                        "dimensions": media.dimensions.model_dump(mode="json") if media.dimensions else None,
